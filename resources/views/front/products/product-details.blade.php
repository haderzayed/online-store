                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 col-md-4 col-12">
                                        <div class="form-group quantity">
                                            ...
                                            <input type="number" value="{{ old('quantity', 1) }}" name="quantity" min="1" class="form-control">
                                ...
                                <div class="bottom-content">
                                    <div class="row align-items-end">
                                        <div class="col-lg-4 col-md-4 col-12">
                                            ...
                                            <button class="btn add-cart" data-id="{{$product->id}}"  style="width: 100%;"> <i class="lni lni-cart"></i>Add to Cart</button>
                                            </div>
                                            {{-- <div class="button">
                                                <a href="javascript:void(0)" class="btn add-cart" data-id="{{$product->id}}"><i class="lni lni-cart"></i> Add to Cart</a>
                                            </div> --}}
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-12">
